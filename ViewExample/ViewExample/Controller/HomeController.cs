...
namespace ViewsExample.Controllers
{
    public class HomeController : Controller
    {
      ...
      {
          new Person() { Name = "Avi", DateOfBirth = DateTime.Parse("2000-05-06"), PersonGender = Gender.Male},
          new Person() { Name = "Savi", DateOfBirth = DateTime.Parse("2005-01-09"), PersonGender = Gender.Female},
          new Person() { Name = "Kavi", DateOfBirth = null, PersonGender = Gender.Other}
      };
            ...
            List<Person> people = new List<Person>()
      {
        ...
        {
            // here view name is currently working action method name
